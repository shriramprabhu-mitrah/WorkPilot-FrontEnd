...
import { Role, CreateRolePayload, UpdateRolePayload } from '@/src/types/settings';
...
class RoleService {
  ...
  async updateRole(roleId: string, payload: UpdateRolePayload): Promise<ApiResponse<Role>> {
  ...
  async deleteRole(roleId: string): Promise<ApiResponse<unknown>> {
