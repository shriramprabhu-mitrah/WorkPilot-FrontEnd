            ...
            >
                ...
                <div className="px-8 pb-6 pt-7">
                    ...
                    <p className="mb-5 text-base text-gray-700 dark:text-slate-300">
                        ...
                        <strong>{completedUserStories} completed user stories</strong> and{' '}
                    ...
                    <ul className="mb-2 space-y-4 pl-6 text-base text-gray-700 dark:text-slate-300">
                        <li className="list-disc">
                            Completed user stories include everything in the last column on
                            the board, Done.
                        </li>

                        <li className="list-disc">
                            In-progress user stories include stories that are not yet
                            completed.
                        </li>
                    </ul>
                </div>
