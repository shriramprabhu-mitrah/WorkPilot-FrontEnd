...
export const SprintDropZone = ({
  ...
  } = useGetSprintUserStories(projectId, sprint.id, !!projectId);
  ...
  } = useGetSprintOrphanTasks(projectId, sprint.id, !!projectId);
          ...
          {isLoading ? (
            ...
            <>
              ...
              {sprintStories.length === 0 ? (
                ...
                <div ref={storiesScrollRef} className="max-h-[220px] overflow-y-auto [scrollbar-width:thin]">
                ...
                {isDirectTasksOpen && (
                  <div className="border-t border-gray-100 dark:border-slate-700/40">
                    {directSprintTasks.length === 0 ? (
                      ...
                      <div ref={tasksScrollRef} className="max-h-[220px] overflow-y-auto [scrollbar-width:thin]">
                        ...
                        {hasNextTasks && (
                          <div ref={tasksSentinelRef} className="flex items-center justify-center py-2">
                            {isFetchingNextTasks && (
                              <div className="flex items-center gap-2 text-xs text-gray-400 dark:text-slate-500">
                                <Loader2 className="w-3 h-3 animate-spin" />
