...
export const useTaskStoryRelationship = (
    projectId: string,
    userStoryId?: string
) => {
    ...
    const {
        ...
        queryFn: () =>
            taskStoryRelationshipService.getTasksByStory(
                projectId,
                userStoryId!
            ),
    ...
    const createTaskUnderStory = useMutation({
        mutationFn: (payload: CreateTaskUnderStoryPayload) =>
            taskStoryRelationshipService.createTaskUnderStory(
                projectId,
                payload
            ),
    ...
    const assignTaskToStory = useMutation({
        mutationFn: ({
            ...
            taskStoryRelationshipService.assignTaskToStory(
                projectId,
                taskId,
                userStoryId
            ),
    ...
    const removeTaskFromStory = useMutation({
        mutationFn: (taskId: string) =>
            taskStoryRelationshipService.removeTaskFromStory(
                projectId,
                taskId
            ),
