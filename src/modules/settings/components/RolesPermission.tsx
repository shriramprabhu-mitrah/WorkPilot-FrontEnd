                ...
                {rolesData.map((role) => {
                    ...
                    return (
                        <button
                            ...
                            <div className={`mx-auto mb-2 flex h-8 w-8 items-center justify-center rounded-full ${role.iconBg
                                    }`}>
                        ...
                        {filteredRoles.map((role) => {
                            ...
                            return (
                                <button
                                    key={role.id}
                                    onClick={() => setSelectedRole(role)}
                                    className={`flex w-full items-center gap-3 rounded-lg border px-3 py-2.5 text-left text-sm transition ${isSelected
                        ...
                        <div className="flex items-start justify-between gap-4">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <span className={`mt-1 inline-block rounded-full px-2.5 py-1 text-xs ${selectedRole.activeBg} ${selectedRole.iconColor}`}
                                    >
                                        {selectedRole.scope}
                                    </span>
                    ...
                    {auditLogs.map((log) => {
                        ...
                        return (
                            <div key={log.id} className="flex gap-3">
                                <div
                                    className={`flex h-7 w-7 shrink-0 items-center justify-center rounded-full ${isSuccess
