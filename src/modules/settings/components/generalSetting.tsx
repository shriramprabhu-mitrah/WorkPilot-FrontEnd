  ...
  return (
    <div className="max-w-2xl rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
      ...
      <div className="mt-6 space-y-5">
        ...
        <div>
          <label className="mb-2 block text-sm font-medium text-gray-700">Organization URL</label>
        ...
        <div>
          <label className="mb-2 block text-sm font-medium text-gray-700">Organization Logo</label>
