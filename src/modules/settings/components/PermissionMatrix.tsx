                ...
                return (
                  <Fragment key={permission.name}>
                    ...
                    <tr className="border-b border-gray-100 last:border-0">
                      ...
                      <td className="w-[12%] px-4 py-4 text-center align-middle">
                        <div className="flex items-center justify-center">
                          <PermissionStatusIcon status={permission.orgAdmin} />
                        </div>
                      </td>

                      <td className="w-[12%] px-4 py-4 text-center align-middle">
                        <div className="flex items-center justify-center">
                          <PermissionStatusIcon status={permission.pm} />
                        </div>
                      </td>

                      <td className="w-[12%] px-4 py-4 text-center align-middle">
                        <div className="flex items-center justify-center">
                          <PermissionStatusIcon status={permission.developer} />
                        </div>
                      </td>

                      <td className="w-[12%] px-4 py-4 text-center align-middle">
                        <div className="flex items-center justify-center">
                          <PermissionStatusIcon status={permission.viewer} />
                        </div>
                      </td>
                    </tr>
                  </Fragment>
