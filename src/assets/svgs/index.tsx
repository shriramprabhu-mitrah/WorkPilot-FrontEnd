...
export const GoogleIconSvg = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    />
    <path
      d="M12 23C14.97 23 17.46 22.02 19.28 20.34L15.72 17.57C14.74 18.23 13.48 18.63 12 18.63C9.14 18.63 6.71 16.7 5.84 14.11H2.17V16.96C3.98 20.57 7.7 23 12 23Z"
      fill="#34A853"
    />
    <path
      d="M5.84 14.11C5.62 13.45 5.49 12.74 5.49 12C5.49 11.26 5.62 10.55 5.84 9.89V7.04H2.17C1.43 8.52 1 10.2 1 12C1 13.8 1.43 15.48 2.17 16.96L5.84 14.11Z"
      fill="#FBBC05"
    />
    <path
      d="M12 5.38C13.62 5.38 15.06 5.94 16.2 7.02L19.35 3.87C17.45 2.09 14.97 1 12 1C7.7 1 3.98 3.43 2.17 7.04L5.84 9.89C6.71 7.3 9.14 5.38 12 5.38Z"
      fill="#EA4335"
    />
  </svg>
);
...
export const ProjectMgmtIconSvg = () => (
  <svg
    fill="none"
    stroke="currentColor"
    viewBox="0 0 24 24"
...
export const AgileBoardIconSvg = () => (
  <svg
    fill="none"
    stroke="currentColor"
    viewBox="0 0 24 24"
...
export const CollaborationIconSvg = () => (
  <svg
    fill="none"
    stroke="currentColor"
    viewBox="0 0 24 24"
